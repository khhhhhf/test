      ...
      >
        ...
        <el-sub-menu index="1">
          ...
          <el-menu-item index="/home/foundation-data"
            ><el-icon><i-ep-Monitor /></el-icon>基本资料</el-menu-item
          >
          <el-menu-item index="/home/change-img"
            ><el-icon><i-ep-Monitor /></el-icon>更换头像</el-menu-item
          >
          <el-menu-item index="/home/change-mm"
            ><el-icon><i-ep-Monitor /></el-icon>重置密码</el-menu-item
          >
        </el-sub-menu>
      </el-menu>
    </el-aside>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="foundation-data"
                  ><el-icon><i-ep-Monitor /></el-icon>基本资料</el-dropdown-item
                >
                <el-dropdown-item command="change-img"
                  ><el-icon><i-ep-Monitor /></el-icon>更换头像</el-dropdown-item
                >
                <el-dropdown-item command="change-mm"
                  ><el-icon><i-ep-Monitor /></el-icon>重置密码</el-dropdown-item
                >
                <el-dropdown-item command="a"
                  ><el-icon><i-ep-Monitor /></el-icon>退出登录</el-dropdown-item
                >
              </el-dropdown-menu>
            </template>
          </el-dropdown>
